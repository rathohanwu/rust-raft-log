...
This is the human-facing runbook for the interactive three-node Docker cluster. For the five-node correctness/robustness test design and runbook, see [the 5-node E2E test design](e2e_5node_test_plan.md).
